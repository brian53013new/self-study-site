    ...
    <footer className="border-t py-8 mt-auto bg-slate-50">
      <div className="container mx-auto px-4 text-center">
        <div 
          ...
          className="text-slate-400 text-xs cursor-default select-none transition-opacity hover:opacity-100 opacity-60 inline-block py-2 px-4 rounded"
        >
          © 2024 自學指南 · v1.2.0
          {isAdmin && (
        ...
        {showPrompt && (
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white p-6 rounded-xl shadow-2xl max-w-sm w-full border animate-in zoom-in-95 duration-200">
              <h3 className="text-lg font-bold mb-4">解鎖開發者模式</h3>
