    ...
    <div className="min-h-screen bg-slate-50 dark:bg-black text-slate-900 dark:text-white transition-colors duration-500 pb-40 font-sans">
      ...
      <div className="border-b border-slate-200 dark:border-white/5 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-3xl sticky top-0 z-50">
        <div className="container mx-auto px-10 py-8 flex justify-between items-center max-w-7xl">
          <div>
            ...
            <p className="text-[10px] text-slate-400 dark:text-zinc-600 tracking-[0.4em] font-bold uppercase mt-1">Brian Secure Dashboard</p>
          </div>
          {!isUnlocked ? (
            ...
            <Button variant="outline" onClick={() => setIsUnlocked(false)} className="text-red-500 border-red-500/20 hover:bg-red-500/5 h-14 px-10 rounded-2xl font-bold">
      ...
      <div className="container mx-auto px-10 py-20 max-w-7xl space-y-20">
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          ...
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="flex justify-between items-start">
              ...
              <Music className="w-20 h-20 text-rose-500 opacity-5" />
            </div>
            <div className="flex justify-between items-end gap-10">
              <div className="space-y-4">
                <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">SOP 會員系統</h2>
                <p className="text-slate-500 dark:text-zinc-500 text-lg max-w-xl">讚美之泉內部管理與資源存取平台。解鎖後可查看專屬登入帳號與加密密碼。</p>
              </div>
              <div className="flex items-center gap-8">
                {isUnlocked && (
                  <div className="bg-slate-50 dark:bg-zinc-900 p-6 rounded-[2rem] border border-slate-200 dark:border-white/5 font-mono text-left">
                    <div className="text-slate-400 dark:text-zinc-500 text-[10px] font-bold uppercase tracking-widest mb-1">Credentials</div>
                ...
                <a href="https://members.sop.org/" target="_blank" rel="noopener noreferrer" className="px-12 py-5 bg-rose-600 hover:bg-rose-700 text-white rounded-2xl text-xl font-bold shadow-lg shadow-rose-600/20 transition-all active:scale-95">進入系統</a>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          ...
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-5 bg-orange-500/10 rounded-2xl border border-orange-500/20 w-fit"><History className="w-12 h-12 text-orange-500" /></div>
            <div className="flex justify-between items-end gap-10">
              <div className="space-y-4">
                <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase">History Zoom</h2>
                <p className="text-slate-500 dark:text-zinc-500 text-lg">歷史脈絡解析與深度專題討論線上教室。提供即時互動與課堂答疑。</p>
              </div>
              <div className="flex items-center gap-8">
                ...
                <a href="https://us06web.zoom.us/j/5844221701?pwd=7fz5sBze027txb5MxbFYpC5g8cnN9a.1" target="_blank" rel="noopener noreferrer" className="px-14 py-6 bg-orange-600 hover:bg-orange-700 text-white rounded-2xl text-2xl font-black shadow-xl">進入 ZOOM</a>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          ...
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-5 bg-emerald-500/10 rounded-2xl border border-emerald-500/20 w-fit"><Cloud className="w-12 h-12 text-emerald-500" /></div>
            <div>
              <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight mb-4">歷史教材雲端資源</h2>
              <p className="text-slate-500 dark:text-zinc-500 text-lg mb-10">存放歷史課程所有講義、參考文獻及課堂錄影存檔。</p>
              {isUnlocked ? (
                <a href="https://drive.google.com/drive/folders/1D3GTOwFTenNT1I1v-5SPNu3lD597mRsr" target="_blank" rel="noopener noreferrer" className="block w-full py-8 bg-slate-100 dark:bg-zinc-900 border-2 border-emerald-500/20 text-emerald-600 dark:text-emerald-500 rounded-[2rem] text-3xl font-black text-center transition-all hover:bg-emerald-50 dark:hover:bg-zinc-800 shadow-xl">OPEN GOOGLE DRIVE</a>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          ...
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-5 bg-violet-500/10 rounded-2xl border border-violet-500/20 w-fit"><MessageSquare className="w-12 h-12 text-violet-500" /></div>
            <div className="flex flex-col md:flex-row justify-between items-end gap-10">
              <div>
                <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">辯論私教課程 (Brian)</h2>
                <p className="text-slate-500 dark:text-zinc-500 text-lg mt-4">高階辯論實戰培訓。包含批判思考與演說技巧。</p>
              </div>
              <div className="flex items-center gap-8">
                {isUnlocked && (
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between hover:border-indigo-500/30 transition-all shadow-xl">
            <div className="p-6 bg-indigo-500/10 rounded-2xl w-fit"><Globe className="w-12 h-12 text-indigo-400" /></div>
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">辯論專題課程 (NGF)</h2>
            <p className="text-slate-500 dark:text-zinc-500 text-lg">國際辯論交流，探討全球時事與多元觀點。</p>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between hover:border-emerald-500/30 transition-all shadow-xl">
            <div className="p-6 bg-emerald-500/10 rounded-2xl w-fit"><Binary className="w-12 h-12 text-emerald-500" /></div>
            <h2 className="text-5xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Abacus Mind</h2>
            <p className="text-slate-500 dark:text-zinc-500 text-lg">高級珠算培訓。請準備好算盤進入教室。</p>
            <a href="https://meet.google.com/znu-vmds-fxi" target="_blank" rel="noopener noreferrer" className="py-10 bg-emerald-600 hover:bg-emerald-700 text-white rounded-[2.5rem] text-3xl font-black text-center shadow-xl shadow-emerald-600/30">進入 GOOGLE MEET</a>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-6 bg-red-500/10 rounded-2xl w-fit"><Sigma className="w-12 h-12 text-red-500" /></div>
            <div className="flex flex-col md:flex-row justify-between items-end gap-10">
              <div className="space-y-4">
                <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Olympiad Math</h2>
                <p className="text-slate-500 dark:text-zinc-500 text-lg">數學競賽邏輯與解題策略。包含深度幾何與代數運算。</p>
              </div>
              <div className="flex items-center gap-8">
                {isUnlocked && <div className="text-5xl font-black text-red-600 dark:text-red-500 font-mono bg-slate-50 dark:bg-zinc-900 px-10 py-5 rounded-3xl border border-slate-200 dark:border-white/5 tracking-tighter">{_0xce("omid")}</div>}
                <a href="https://meet.google.com/wjn-atpi-ifx" target="_blank" rel="noopener noreferrer" className="px-12 py-6 bg-red-600 hover:bg-red-700 text-white rounded-2xl text-2xl font-black shadow-xl">進入教室</a>
              </div>
            </div>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-6 bg-blue-500/10 rounded-2xl w-fit"><Calculator className="w-12 h-12 text-blue-500" /></div>
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">慶元數學系統課程</h2>
            <p className="text-slate-500 dark:text-zinc-500 text-lg">系統化數學觀念建立與解題訓練。</p>
            <a href="https://meet.google.com/ddr-hdrt-eru" target="_blank" rel="noopener noreferrer" className="py-10 bg-blue-600 hover:bg-blue-700 text-white rounded-[2.5rem] text-3xl font-black text-center shadow-xl">進入視訊教室</a>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-6 bg-teal-500/10 rounded-2xl w-fit"><Microscope className="w-12 h-12 text-teal-500" /></div>
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight">英文理化專題課程</h2>
            <p className="text-slate-500 dark:text-zinc-500 text-lg">全英文環境探討科學概念，強化專業英文表達。</p>
            <a href="https://meet.google.com/fzm-ecmz-api" target="_blank" rel="noopener noreferrer" className="py-10 bg-teal-600 hover:bg-teal-700 text-white rounded-[2.5rem] text-3xl font-black text-center shadow-xl">OPEN MEET</a>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-6 bg-purple-500/10 rounded-2xl w-fit"><BookOpen className="w-12 h-12 text-purple-500" /></div>
            <div className="flex flex-col md:flex-row justify-between items-end gap-10">
              <div>
                <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tight uppercase">Henry Club</h2>
                <p className="text-slate-500 dark:text-zinc-500 text-lg mt-4">專屬讀書會平台。解鎖後查看登入帳號密碼。</p>
              </div>
              <div className="flex items-center gap-8">
                <a href="https://course.henrypedia.com/login" target="_blank" rel="noopener noreferrer" className="px-12 py-5 bg-purple-600 hover:bg-purple-700 text-white rounded-2xl text-xl font-bold shadow-xl">前往登入</a>
                {isUnlocked && (
                  <div className="bg-slate-50 dark:bg-zinc-900 p-6 rounded-2xl border border-slate-200 dark:border-white/5 font-mono text-center">
                    <div className="text-slate-400 dark:text-zinc-600 text-[10px] font-black uppercase mb-1">ID: {_0xce("hu")}</div>
                    <div className="text-2xl font-black text-purple-500 tracking-tighter">PW: {_0xce("hp")}</div>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col items-center justify-center text-center shadow-xl hover:border-cyan-500/20 transition-all">
            <div className="p-6 bg-cyan-500/10 rounded-full mb-8"><Brain className="w-16 h-16 text-cyan-500" /></div>
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter uppercase mb-6">Hour of AI</h2>
            <a href="https://code.org/en-US/hour-of-ai" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 text-2xl font-black hover:underline flex items-center gap-4 transition-all">START STUDY <ExternalLink className="w-8 h-8" /></a>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col items-center justify-center text-center shadow-xl hover:border-cyan-500/20 transition-all">
            <div className="p-6 bg-cyan-500/10 rounded-full mb-8"><Sparkles className="w-16 h-16 text-cyan-500" /></div>
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter uppercase mb-6 leading-tight">Kyros AI Special</h2>
            <a href="https://www.kyros.ai/special-program-detail/22130" target="_blank" rel="noopener noreferrer" className="text-cyan-600 dark:text-cyan-400 text-2xl font-black hover:underline flex items-center gap-4 transition-all">VISIT PROGRAM <ExternalLink className="w-8 h-8" /></a>
          </Card>
        </div>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col items-center justify-center text-center shadow-xl hover:border-red-500/20 transition-all">
            <div className="p-8 bg-red-500/10 rounded-full mb-10"><Globe className="w-20 h-20 text-red-600" /></div>
            <h2 className="text-5xl font-black text-slate-900 dark:text-white tracking-tighter uppercase mb-8">EDX Global</h2>
        ...
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
            <div className="p-6 bg-blue-500/10 rounded-2xl w-fit"><GraduationCap className="w-16 h-16 text-blue-500" /></div>
            <div className="flex flex-col md:flex-row justify-between items-end gap-10">
              ...
              <div className="flex items-center gap-8">
                {isUnlocked && (
                  <div className="bg-slate-50 dark:bg-zinc-900 p-8 rounded-[2rem] border border-slate-200 dark:border-white/5 font-mono text-center">
                    <div className="text-slate-400 dark:text-zinc-600 text-[10px] font-black mb-1 uppercase tracking-widest">ID: {_0xce("u")}</div>
                    <div className="text-3xl font-black text-blue-600 dark:text-blue-500 tracking-tighter">{_0xce("p")}</div>
                  </div>
                )}
        ...
        {/* 15. SOP 官方網站 */}
        <div className="group relative aspect-[2.5/1] w-full">
          <Card className="relative h-full bg-white dark:bg-zinc-950 border border-slate-200 dark:border-white/10 rounded-[4rem] p-16 flex flex-col items-center justify-center text-center shadow-xl hover:border-rose-500/20 transition-all">
            <div className="p-10 bg-rose-50 dark:bg-rose-500/10 rounded-full mb-10 border border-rose-100 dark:border-rose-500/20"><Layout className="w-20 h-20 text-rose-500" /></div>
            <h2 className="text-4xl font-black text-slate-900 dark:text-white tracking-tighter uppercase mb-6">SOP Official</h2>
            <a href="https://www.sop.org/" target="_blank" rel="noopener noreferrer" className="text-rose-600 dark:text-rose-400 text-3xl font-black hover:underline transition-all tracking-tight">BROWSE WEBSITE</a>
          </Card>
        </div>
