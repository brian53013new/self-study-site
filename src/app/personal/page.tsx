      ...
      <div className="border-b border-slate-200 dark:border-white/5 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-3xl sticky top-0 z-50">
        <div className="container mx-auto px-6 py-6 flex justify-between items-center max-w-7xl">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-black tracking-tighter italic">Personal Dashboard</h1>
          </div>
          <div className="flex items-center gap-4">
            {!isUnlocked ? (
      ...
      <div className="container mx-auto px-6 py-12 max-w-7xl flex flex-col lg:flex-row gap-12">
        ...
        <aside className="hidden lg:block w-64 shrink-0 sticky top-32 h-fit">
          <nav className="space-y-2">
            <p className="text-[10px] font-black text-slate-400 dark:text-zinc-600 tracking-[0.3em] uppercase mb-4 ml-4">Categories</p>
            ...
            <button onClick={() => scrollToSection('platforms')} className="w-full flex items-center justify-between px-4 py-3 rounded-xl hover:bg-slate-100 dark:hover:bg-zinc-900 transition-all group text-left">
              <span className="font-bold flex items-center gap-3"><GraduationCap className="w-4 h-4 text-blue-500" /> 學習平台</span>
              <ChevronRight className="w-4 h-4 opacity-0 group-hover:opacity-100 transition-opacity" />
            </button>
            ...
            <div className="pt-10 border-t border-slate-200 dark:border-white/5 mt-10 text-center">
              <button onClick={() => { sessionStorage.removeItem('personal_access'); router.push('/'); }} className="text-slate-400 hover:text-red-500 text-xs font-black uppercase tracking-widest transition-colors">Logout Terminal</button>
            </div>
          </nav>
        </aside>
            ...
            <div className="space-y-12">
              ...
              <div className="group relative aspect-[2.5/1]">
                ...
                <Card className="relative h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[4rem] p-12 flex flex-col justify-between shadow-xl">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    {isUnlocked && <div className="text-5xl font-black text-orange-500 font-mono tracking-tighter bg-slate-50 dark:bg-zinc-900 px-10 py-4 rounded-2xl border dark:border-white/5">{_0xce("zid")}</div>}
                  </div>
                </Card>
              </div>
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    {isUnlocked && (
                      <div className="bg-slate-50 dark:bg-zinc-900 p-6 rounded-2xl border dark:border-white/5 font-mono text-right flex-1">
                        <div className="text-slate-400 text-[10px] font-black uppercase">Dial-in (US): {_0xce("dpu")}</div>
                        <div className="text-4xl font-[1000] text-violet-600 dark:text-violet-500">PIN: {_0xce("dpin")}</div>
                      </div>
                    )}
                  </div>
                </Card>
              ...
              <div className="group relative aspect-[2.5/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[4rem] p-12 flex flex-col justify-between shadow-xl">
                  ...
                  <a href="https://us06web.zoom.us/j/84058999858?pwd=KdtAd1z6bbROvcrFybThyu3ijODiDW.1" target="_blank" rel="noopener noreferrer" className="py-10 bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-white/10 text-indigo-600 dark:text-indigo-400 rounded-3xl text-3xl font-black text-center shadow-xl transition-all">進入 ZOOM 會議</a>
                </Card>
              </div>
              ...
              <div className="group relative aspect-[2.5/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[4rem] p-12 flex flex-col justify-between shadow-xl">
                  ...
                  <div className="flex items-center gap-8">
                    ...
                    {isUnlocked && <div className="text-5xl font-black text-red-600 font-mono tracking-tighter bg-slate-50 dark:bg-zinc-900 px-10 py-4 rounded-2xl border dark:border-white/5">{_0xce("omid")}</div>}
                  </div>
                </Card>
              </div>
              ...
              <div className="group relative aspect-[2.5/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[4rem] p-16 flex flex-col justify-between shadow-xl">
                  <div className="flex justify-between items-start">
                    ...
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white">SOP 會員系統</h3>
                  </div>
                  <div className="flex items-center gap-8">
                    ...
                    {isUnlocked && (
                      <div className="bg-slate-50 dark:bg-zinc-900 p-8 rounded-3xl border border-slate-200 dark:border-white/5 font-mono flex-1 text-left">
                        <div className="text-slate-400 dark:text-zinc-600 text-xs font-black uppercase mb-1 tracking-widest">Email address</div>
                        <div className="text-xl text-slate-800 dark:text-white font-bold">{_0xce("su")}</div>
                        <div className="text-3xl font-black text-rose-600 dark:text-rose-500 mt-1">{_0xce("sp")}</div>
                      </div>
                    )}
                  </div>
                </Card>
              ...
              <div className="group relative aspect-[3/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[3rem] p-12 flex items-center justify-between shadow-xl">
                  <div className="flex items-center gap-8">
                    ...
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white">SOP Official Site</h3>
                  </div>
                  <a href="https://www.sop.org/" target="_blank" rel="noopener noreferrer" className="text-rose-600 dark:text-rose-400 text-2xl font-black hover:underline transition-all">開啟官方網站</a>
                </Card>
              </div>
              ...
              <div className="group relative aspect-[3/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[3rem] p-12 flex items-center justify-between shadow-xl">
                  <div className="flex items-center gap-8">
                    ...
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white">歷史課程教材庫</h3>
                  </div>
                  {isUnlocked ? (
                    <a href="https://drive.google.com/drive/folders/1D3GTOwFTenNT1I1v-5SPNu3lD597mRsr" target="_blank" rel="noopener noreferrer" className="px-10 py-5 bg-zinc-900 text-emerald-500 border border-emerald-500/20 rounded-2xl text-xl font-black transition-all hover:bg-zinc-800">開啟雲端硬碟</a>
                  ) : <div className="text-slate-300 dark:text-zinc-800 text-2xl font-black italic">Security Locked</div>}
                </Card>
              </div>
              ...
              <div className="group relative aspect-[3/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[3rem] p-12 flex items-center justify-between shadow-xl">
                  <div className="flex items-center gap-8">
                    ...
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white text-cyan-600 dark:text-cyan-400">Hour of AI</h3>
                  </div>
                  <a href="https://code.org/en-US/hour-of-ai" target="_blank" rel="noopener noreferrer" className="text-slate-400 dark:text-zinc-600 hover:text-cyan-500 transition-colors"><ExternalLink className="w-10 h-10" /></a>
                </Card>
              </div>
              ...
              <div className="group relative aspect-[3/1]">
                <Card className="h-full bg-white dark:bg-zinc-950 border-slate-200 dark:border-white/5 rounded-[3rem] p-12 flex items-center justify-between shadow-xl">
                  <div className="flex items-center gap-8">
                    ...
                    <h3 className="text-3xl font-black text-slate-900 dark:text-white text-cyan-600 dark:text-cyan-400">Kyros AI Special Program</h3>
                  </div>
                  <a href="https://www.kyros.ai/special-program-detail/22130" target="_blank" rel="noopener noreferrer" className="text-slate-400 dark:text-zinc-600 hover:text-cyan-500 transition-colors"><ExternalLink className="w-10 h-10" /></a>
                </Card>
              </div>
